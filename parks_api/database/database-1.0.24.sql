...
VALUES
	...
	(109,22,NULL,'ff99cc',2221),
	(110,21,NULL,'ff0000',2518),
	(111,3,NULL,'ffff00',3900),
	(112,3,NULL,'ffff00',3950),
	(113,22,NULL,'ff99cc',2253),
	(114,79,NULL,'0066ff',2130),
	(115,22,NULL,'ff99cc',2247),
	(116,22,NULL,'ff99cc',2248),
	(117,20,NULL,'ff7b21',2447),
	(118,20,NULL,'ff7b21',2448),
	(119,100,NULL,'d8d8d8',2632),
	(120,100,NULL,'d8d8d8',2634),
	(121,100,NULL,'d8d8d8',2636),
	(5000,0,NULL,'00501f',1500),
	(5001,5000,NULL,'00501f',1510),
	(5002,5000,NULL,'00501f',1520);
...
VALUES
	...
	(118,'de','Parkverwaltung'),
	(118,'en','Park administration'),
	(118,'fr','Administration du parc'),
	(118,'it','Gestione dei parcheggi'),
	(119,'de','Parkverwaltung'),
	(119,'en','Park administration'),
	(119,'fr','Administration du parc'),
	(119,'it','Gestione dei parcheggi'),
	(120,'de','Bewirtschaftete Alp'),
	(120,'en','Alpine huts offering regional product'),
	(120,'fr','Alpage exploité'),
	(120,'it','Alpeggio'),
	(121,'de','Wassersport'),
	(121,'en','Watersports'),
	(121,'fr','Sports aquatique'),
	(121,'it','Sport acquatico'),
	(5000,'de','Forschungsprojekt'),
	(5000,'en','Research project'),
	(5000,'fr','Projet de recherche'),
	(5000,'it','Progetto di ricerca'),
	(5001,'de','Verantwortung Forschungsprojekt'),
	(5001,'en','Responsibility for the research project'),
	(5001,'fr','Responsabilité du projet de recherche'),
	(5001,'it','Responsabilità del progetto di ricerca'),
	(5002,'de','Feldarbeit'),
	(5002,'en','Fieldwork'),
