...
CREATE TABLE `map_layer` (
  ...
  `export_config_id` int(11) DEFAULT NULL,
  ...
  KEY `export_config_id_idxfk` (`export_config_id`),
  CONSTRAINT `map_layer_ibfk_1` FOREIGN KEY (`export_config_id`) REFERENCES `export_config` (`export_config_id`) ON DELETE CASCADE
